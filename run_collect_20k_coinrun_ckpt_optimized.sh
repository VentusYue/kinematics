#!/bin/bash
# =============================================================================
# Meta-RL Route Collection (CoinRun) with Checkpointing - OPTIMIZED collector
#
# Based on:
# - eval/collect_meta_routes_optimized.py
# - run_collect_10k_coinrun_ckpt.sh
#
# Features:
...
# - Faster collection path: persistent env workers + optimized obs/inference data path
#
# Usage:
#   ./run_collect_10k_coinrun_ckpt_optimized.sh              # Start or resume collection
#   ./run_collect_10k_coinrun_ckpt_optimized.sh --fresh      # Force fresh start (delete old checkpoint)
# =============================================================================
...
EXP_NAME="run_20k_coinrun_ckpt_optimized"
...
echo ""
echo "╔══════════════════════════════════════════════════════════════╗"
echo "║  META-RL ROUTE COLLECTION (CoinRun) WITH CHECKPOINTING (OPT) ║"
echo "╚══════════════════════════════════════════════════════════════╝"
echo ""
...
echo "  5. Resume collection: ./run_collect_10k_coinrun_ckpt_optimized.sh"
echo ""
