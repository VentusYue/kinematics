#!/bin/bash
# =============================================================================
# Meta-RL Route Collection (Optimized with Filtering) - 10k tasks
#
# Based on: /root/backup/kinematics/run_collect.sh
# Updated for:
# - New checkpoint: meta-rl-maze-easy-n10k-trial10-dense-gpu-opt/model_step_55967744.tar
# - Collect 10,000 successful trajectories
# - Increased max steps / episode length
# =============================================================================
...
EXP_NAME="run_random_seeds_10k_gpuopt_step55967744"
...
# Increased from 64 -> 256 to allow longer maze trajectories
MAX_STEPS=128              # Max steps per episode
MAX_EP_LEN=64             # Max episode length to keep (also used by selector)
