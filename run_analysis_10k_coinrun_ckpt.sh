#!/bin/bash
# =============================================================================
# Meta-RL Behavior-Neural Alignment Analysis Pipeline (CoinRun 10k collection)
#
# Target collection:
#   run_10k_coinrun_ckpt (with checkpointing)
#
# Runs:
...
#
# Usage:
#   ./run_analysis_10k_coinrun_ckpt.sh                    # Full pipeline
#   ./run_analysis_10k_coinrun_ckpt.sh --skip-pkd         # Skip PKD, use existing cycles
#   ./run_analysis_10k_coinrun_ckpt.sh --use-partial      # Export from checkpoint first
#   ./run_analysis_10k_coinrun_ckpt.sh --use-partial --skip-pkd  # Use partial + skip PKD
# =============================================================================
...
# Source collection experiment
COLLECT_EXP_NAME="run_10k_coinrun_ckpt"

# Output experiment name (analysis outputs go under BASE_OUT_DIR/EXP_NAME/)
EXP_NAME="run_10k_coinrun_ckpt_analysis"
...
COLLECTION_TAG="CoinRun 10k with checkpointing"
