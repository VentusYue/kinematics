#!/bin/bash
# =============================================================================
# Meta-RL Route Collection (Heist) with Checkpointing - OPTIMIZED collector
#
# Collector:
#   eval/collect_meta_routes_optimized.py
#
# Usage:
#   ./run_collect_20k_heist_ckpt_optimized.sh              # Start or resume collection
#   ./run_collect_20k_heist_ckpt_optimized.sh --fresh      # Force fresh start (delete old checkpoint)
# =============================================================================
...
EXP_NAME="run_20k_heist_ckpt_optimized_step066060288"

# From: /root/logs/ppo/meta-rl-heist-easy-step1024-n1k-trial10-gpu0=lr2e4/saved/
MODEL_CKPT="/root/logs/ppo/meta-rl-heist-easy-step1024-n1k-trial10-gpu0=lr2e4/saved/model_step_66060288.tar"
...
echo ""
echo "╔══════════════════════════════════════════════════════════════╗"
echo "║  META-RL ROUTE COLLECTION (Heist) WITH CHECKPOINTING (OPT)   ║"
echo "╚══════════════════════════════════════════════════════════════╝"
echo ""
