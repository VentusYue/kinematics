#!/bin/bash
# =============================================================================
# Meta-RL Route Collection (CoinRun)
#
# Mirrors:
#   kinematics/run_collect_10k_gpuopt_step170196992.sh
#
# Notes:
# - Uses updated `eval/collect_meta_routes.py` which now supports CoinRun state
#   parsing via procgen `get_state()` (player x/y + extra per-step features).
# - You MUST set MODEL_CKPT to a CoinRun-trained RL² checkpoint.
# =============================================================================
...
EXP_NAME="run_random_seeds_10k_gpuopt_step170196992_coinrun"
...
echo ""
echo "╔══════════════════════════════════════════════════════════════╗"
echo "║         META-RL ROUTE COLLECTION (CoinRun)                   ║"
echo "╚══════════════════════════════════════════════════════════════╝"
echo ""
