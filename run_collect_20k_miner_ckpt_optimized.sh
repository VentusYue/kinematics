#!/bin/bash
# =============================================================================
# Meta-RL Route Collection (Miner) with Checkpointing - OPTIMIZED collector
#
# Collector:
#   eval/collect_meta_routes_optimized.py
#
# Usage:
#   ./run_collect_20k_miner_ckpt_optimized.sh              # Start or resume collection
#   ./run_collect_20k_miner_ckpt_optimized.sh --fresh      # Force fresh start (delete old checkpoint)
# =============================================================================
...
EXP_NAME="run_20k_miner_ckpt_optimized_step119406592"

# From: /root/logs/ppo/meta-rl-miner-easy-step1024-n1k-trial10-gpu1=lr2e4/saved/
MODEL_CKPT="/root/logs/ppo/meta-rl-miner-easy-step1024-n1k-trial10-gpu1=lr2e4/saved/model_step_119406592.tar"
...
echo ""
echo "╔══════════════════════════════════════════════════════════════╗"
echo "║  META-RL ROUTE COLLECTION (Miner) WITH CHECKPOINTING (OPT)   ║"
echo "╚══════════════════════════════════════════════════════════════╝"
echo ""
...
#
# Notes:
# - Defaults to cuda:1 (cuda:0 was heavily utilized per recent nvidia-smi).
# - Defaults NUM_PROCESSES=64 to reduce contention; override if you have headroom:
#     NUM_PROCESSES=128 DEVICE=cuda:0 ./run_collect_20k_miner_ckpt_optimized.sh
#
# Usage:
#   ./run_collect_20k_miner_ckpt_optimized.sh              # Start or resume collection
#   ./run_collect_20k_miner_ckpt_optimized.sh --fresh      # Force fresh start (delete old checkpoint)
...
echo ""
echo "Next steps:"
echo "  - Run your analysis pipeline pointing at: ${ROUTES_NPZ}"
echo "  - Resume later by re-running this script (or use --fresh to restart)."
echo ""
