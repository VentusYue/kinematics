...
parser.add_argument(
    ...
    type=lambda x: bool(strtobool(x)),
    default=True,
    help="Whether to log with wandb or save results locally (default: True)",
)
parser.add_argument(
    "--wandb_project",
    type=str,
...
parser.add_argument(
    "--eval_video_envs",
    type=str,
    default="maze,chaser,heist",
    help="Comma separated list of environments to record videos for",
)
parser.add_argument(
    "--eval_video_episodes",
    type=int,
