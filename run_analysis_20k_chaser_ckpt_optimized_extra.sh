#!/bin/bash
# =============================================================================
# Meta-RL Behavior-Neural Alignment Analysis Pipeline (Chaser 20k) — EXTRA (skip PKD)
#
# IMPORTANT:
# - This script defaults to skipping PKD and re-running CCA + stats in-place.
...
#   /root/backup/kinematics/experiments/run_20k_chaser_ckpt_optimized_analysis/logs/analysis.log
#
# Usage:
#   ./run_analysis_20k_chaser_ckpt_optimized_extra.sh          # default: skip PKD
#   ./run_analysis_20k_chaser_ckpt_optimized_extra.sh --run-pkd  # recompute PKD then CCA+stats
# =============================================================================
...
EXP_NAME="run_20k_chaser_ckpt_optimized_analysis"   # must match existing folder for --skip-pkd
...
echo ""
echo "╔══════════════════════════════════════════════════════════════╗"
echo "║   META-RL ALIGNMENT ANALYSIS PIPELINE (Chaser) — EXTRA       ║"
echo "╚══════════════════════════════════════════════════════════════╝"
echo ""
